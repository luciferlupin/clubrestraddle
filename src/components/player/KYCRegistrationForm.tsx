      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: '0.78rem', color: '#cbd5e1', margin: 0, lineHeight: 1.45 }}>
            Please present the QR code below to the <strong>Security Guard</strong> at the door. Upon security verification and entrance approval, your ₹500 entry fee (inclusive of 5% GST) will be processed and official tax invoice issued.
          </p>
        </div>
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(255, 255, 255, 0.08)', paddingBottom: '10px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span style={{ fontWeight: 800, color: '#ffffff', fontSize: '0.9rem' }}>Entry Gate Fee Tax Invoice (SAC 999691 • 5% GST)</span>
              </div>
              <span
                style={{
                  fontSize: '0.72rem',
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.94rem', fontWeight: 800, color: '#ffffff', borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '8px' }}>
              <span>Total Gate Fee Charged (Incl. 5% GST):</span>
