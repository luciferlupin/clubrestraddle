    ...
    walletHistory: [
      {
        ...
        amount: 150000,
        direction: 'credit',
        description: '🏆 1st Place Champion Prize - Noida Masters Kickoff Series',
        referenceId: 'TRN-2026-00',
        timestamp: '2026-08-22T23:30:00Z',
        performedBy: 'Jai Goel (Admin)',
        balanceAfter: 150000,
      },
    ],
    kyc: {
    ...
    walletHistory: [
      {
        ...
        amount: 90000,
        direction: 'credit',
        description: '🏆 2nd Place Runner-up Prize - Noida Masters Kickoff Series',
        referenceId: 'TRN-2026-00',
        timestamp: '2026-08-22T23:30:00Z',
        performedBy: 'Jai Goel (Admin)',
        balanceAfter: 90000,
...
export const initialTournaments: Tournament[] = [
  {
    id: 'TRN-2026-00',
    name: 'Noida Masters Kickoff Series',
    buyInFee: 15000,
    clubRake: 1500,
    startingChips: 35000,
    guaranteedPrizePool: 300000,
    maxSeats: 30,
    ...
    winners: [
      {
        ...
        playerPhone: '+91 98102 34891',
        prizeAmount: 150000,
        awardedAt: '2026-08-22T23:30:00Z',
        awardedBy: 'Jai Goel (Admin)',
        notes: 'Championship Winner (1st Place)',
      },
      {
        rank: 2,
        playerId: 'MEM-1002',
...
export const initialEntries: TournamentEntry[] = [
  {
    ...
    receiptNumber: 'CRS/TRN-01/26-27/0001',
    tableNumber: '1',
    seatNumber: '4',
